...
mergeStrings('abcde', 'cdefg'); // "abcde" + "cdefgh" => "abcdefgh"
mergeStrings("abaab", "aabab"); // "abaab" + "aabab" => "abaabab"
mergeStrings("abc", "def");  // "abc" + "def" => "abcdef" 
mergeStrings("abc", "abc"); // "abc" + "abc" => "abc"